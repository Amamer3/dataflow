...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          id: string
          phone: string | null
          role: 'user' | 'admin' | 'super_admin' | 'suspended' | null
          updated_at: string
        }
        Insert: {
          created_at?: string
    ...
    Enums: {
      ...
      txn_status: "pending" | "processing" | "success" | "failed" | "refunded"
      txn_type: "data_purchase" | "wallet_topup" | "refund"
    }
    CompositeTypes: {
      [_ in never]: never
    }
